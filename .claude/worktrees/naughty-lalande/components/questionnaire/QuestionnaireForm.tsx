  ...
  if (!currentQuestion) {
    return (
      <div className="h-full flex items-center justify-center">
        ...
        <button onClick={onExit} className="ml-4 text-ai-accent">
          Voltar
        </button>
      </div>
    );
      ...
      <div className="max-w-3xl mx-auto w-full space-y-6">
        ...
        <div className="bg-white rounded-lg border border-ai-border p-4">
          ...
          <div className="mb-2">
            ...
            <div className="text-right text-xs text-ai-subtext mt-1">{Math.floor(progress)}% concluído</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-ai-border p-6 shadow-sm">
          <div className="mb-4 min-h-[6.5rem]">
            <p className="text-sm font-medium text-ai-subtext mb-2">
              {currentQuestion.category} - {currentQuestion.group}
            </p>
