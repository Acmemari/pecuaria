-- Copie TODO o conteúdo deste arquivo no Supabase → SQL Editor → Run.
-- Cria a tabela saved_questionnaires para que questionários preenchidos apareçam em Meus Salvos.
