...
DROP POLICY IF EXISTS "Users can view own saved questionnaires" ON saved_questionnaires;
DROP POLICY IF EXISTS "Users can insert own saved questionnaires" ON saved_questionnaires;
DROP POLICY IF EXISTS "Users can update own saved questionnaires" ON saved_questionnaires;
DROP POLICY IF EXISTS "Users can delete own saved questionnaires" ON saved_questionnaires;
