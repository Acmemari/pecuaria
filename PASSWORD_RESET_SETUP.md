...
2. **URL sem protocolo**: Se a URL no email estiver sem `https://` (ex: `gesttor.ai/reset-password`), configure o Site URL no Supabase com `https://gesttor.ai`

3. **Verifique se a URL de redirecionamento está configurada corretamente** no Supabase Dashboard:
   - Authentication > URL Configuration > Site URL: `https://gesttor.ai`
   - Authentication > URL Configuration > Redirect URLs: `https://gesttor.ai` e `https://gesttor.ai/**`
