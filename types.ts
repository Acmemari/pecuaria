...
export interface AuthContextType {
  ...
  logout: () => void;
  isLoading: boolean;
  /** true quando onAuthStateChange já resolveu (ex: INITIAL_SESSION) — seguro para fetches */
  ...
  /** Obtém o token JWT atual (assíncrono, sempre fresco). Use em chamadas à API. */
