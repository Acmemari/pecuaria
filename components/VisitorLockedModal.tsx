  ...
  return (
    ...
    >
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="visitor-locked-modal-title"
      >
        {/* Header gradient */}
        <div className="bg-gradient-to-br from-emerald-600 via-green-500 to-teal-500 p-6 pb-8 text-white">
          ...
          <div className="flex flex-col items-center text-center gap-3">
            ...
            <div>
              ...
              <h2 id="visitor-locked-modal-title" className="text-xl font-bold">
          ...
          {submitted ? (
            ...
            <>
              <p className="text-sm text-ai-subtext text-center mb-5">
                Quer conhecer como a equipe <strong className="text-ai-text">Inttegra</strong> pode
                transformar a gestão da sua pecuária com ferramentas como essa?
              </p>

              <form onSubmit={handleSubmitForm} className="space-y-3">
                <div>
                  <label htmlFor="visitor-name" className="text-xs font-semibold text-ai-subtext block mb-1">
                    Seu nome
                  </label>
                  <input
                    id="visitor-name"
                ...
                <div>
                  <label htmlFor="visitor-phone" className="text-xs font-semibold text-ai-subtext block mb-1">
                    WhatsApp
                  </label>
                  <input
                    id="visitor-phone"
