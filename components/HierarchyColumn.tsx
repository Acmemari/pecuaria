...
const SortableHierarchyItem: React.FC<{
  ...
  ({ item, index, items, selectedId, accentClassName, onSelect, onEdit, onDelete, onMoveUp, onMoveDown }) => {
    ...
    return (
      <div
        ...
        {...attributes}
        {...listeners}
        className="touch-manipulation transition-transform duration-150"
      >
        <CardContent
          item={item}
