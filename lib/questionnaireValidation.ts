...
export const validateAnswers = (
  ...
  const unanswered = questionIds.filter(id => answers[id] === null || answers[id] === undefined);
 ...
 */
export const validatePositiveNumber = (value: number | string, fieldName: string = 'Valor'): ValidationResult => {
