...
export async function fetchFarmsWithRetry(userId: string) {
    try {
        ...
        const farms = await withSupabaseRetry(
            async () => {
        ...
        handleQuestionnaireError(
            error,
            'fetchFarmsWithRetry',
            (message, type) => console.error(message)
        );
        throw error;
    }
}
...
export async function processQuestionnaireWithMetrics(
    questionnaireId: string,
    answers: Record<string, 'Sim' | 'Não'>
) {
...
export async function deleteQuestionnaireWithErrorHandling(id: string) {
    try {
        ...
        handleQuestionnaireError(
            error,
            'deleteQuestionnaireWithErrorHandling',
            (message, type) => {
