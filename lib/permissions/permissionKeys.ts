...
export const PERMISSION_KEYS: PermissionKeyDef[] = [
  ...
  },
  {
    ...
    label: 'Contratos',
    description: 'Gestão de contratos e workflow de status',
  ...
  },
  {
    ...
    label: 'Documentos Confidenciais',
    description: 'Acesso a documentos confidenciais e restritos',
    location: 'Documentos > Confidenciais',
    icon: 'Lock',
    category: 'documentos',
  },
  {
    ...
    description: 'Visualizar histórico de ações em documentos',
    location: 'Documentos > Auditoria',
    icon: 'History',
    category: 'documentos',
  },
  // Assistentes
