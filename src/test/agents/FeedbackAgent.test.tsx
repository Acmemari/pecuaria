...
describe('FeedbackAgent Component', () => {
    ...
    beforeEach(() => {
        ...
        (fetchPeople as any).mockResolvedValue([
            { id: 'person-1', full_name: 'Person One', preferred_name: 'P1' }
        ]);
    ...
    it('saves the generated feedback', async () => {
        ...
        fireEvent.change(screen.getByPlaceholderText(/Ex: reforçar pontos fortes/i), { target: { value: 'Valid objective text' } });
        fireEvent.change(screen.getByPlaceholderText(/Digite o nome de quem receberá o feedback/i), { target: { value: 'João' } });
